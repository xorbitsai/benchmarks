...
def run_queries(
    ...
    for query in queries:
        try:
            ...
            if log_time:
                append_row("duckdb", query, dur, duckdb.__version__, success)
